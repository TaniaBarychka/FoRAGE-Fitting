...
hr1_na_PreyPred<-lm(LogFittedH_day~LogPreyBM+LogPredBM, data=df_na_hr)
summary(hr1_na_PreyPred)

hr1_na_PreyPredTemp<-lm(LogFittedH_day~LogPreyBM+LogPredBM+Temp_c,data=df_na_hr)
summary(hr1_na_PreyPredTemp)


#anova(hr1_na_PreyPredTemp, hr1_na_PreyPred)

hr1_na_PreyPredEcEn<-lm(LogFittedH_day~LogPreyBM+LogPredBM+as.factor(EctoEndo),data=df_na_hr)
summary(hr1_na_PreyPredEcEn)

#anova(hr1_na_PreyPredEcEn,hr1_na_PreyPred)

inHr_na<-lm(LogFittedH_day~LogPreyBM+LogPredBM+Temp_c*EctoEndo, data = df_na_hr)
summary(inHr_na)
