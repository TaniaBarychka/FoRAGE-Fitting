...
ar1_opt_na<-lm(df_na$L.Fitted.a..median.of.BS.samples.~df_na$L.PredBM+df_na$Temp..C.., data=df_na)
pred<-predict.lm(ar1_opt_na, newdata)
plot(df_na$L.PredBM, df_na$L.Fitted.a..median.of.BS.samples.)
...
Predictions of the current model are over-predicting the data. Look at the model with interaction: hopefully it'd be a better fit.
