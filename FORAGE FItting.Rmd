...
L.predBM_sim<-rnorm(100000, mean=2.251, sd=5.713)
hist(L.predBM_sim)
...
L.preyBM_sim<-rnorm(100000, mean=-2.5298, sd=5.974)
hist(L.preyBM_sim)
...
pairs(forage_db[,c(49,50,52, 48, 47)], panel=panel.smooth)
...
```{r}
forage_inf<-subset(forage_db, forage_db[,52]!="-Inf")

ar3_opt_full<-lm(forage_inf$L.Fitted.a..median.of.BS.samples.~forage_inf$L.PredBM+forage_inf$temp_A)
summary(ar3_opt_full)
